...
extern struct interrupt_descriptor IDT_Table[256];

void set_idt_gate(struct interrupt_descriptor *ptr, uint64_t offset, uint16_t selector, uint8_t ist, uint8_t type_attributes);
